    ...
    <main className="py-8">
      <section id="features">
        <div className="container mx-auto px-8 font-worksans"> 
          ...
          {/* First Row */}
          <div className="flex flex-col sm:flex-row justify-between items-center gap-[8px] sm:gap-[15px] md:gap-[20px] lg:gap-[20px] mt-[15px] sm:mt-[30px] md:mt-[40px] lg:mt-[50px] xl:ml-[120px]">
            ...
            <div className="flex flex-col items-center w-full sm:w-[45%] md:w-[55%] lg:w-[35%] xl:mr-[100px]">
              <Image 
          ...
          <div className="flex flex-col sm:flex-row justify-between items-center gap-[10px] sm:gap-[15px] md:gap-[20px] lg:gap-[25px] mt-[30px] sm:mt-[40px] md:mt-[50px] lg:mt-[60px]">
            <div className="flex flex-col items-center w-full sm:w-[45%] md:w-[55%] lg:w-[35%] xl:ml-[120px]">
              <Image 
            ...
            <div className="flex flex-col items-center w-full sm:w-[45%] md:w-[55%] lg:w-[35%] xl:mr-[100px] md:mr-[-30px]">
              <Image 
